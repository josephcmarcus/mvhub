...
module.exports.processSaleHook = (req, res) => {
    const { event, thrivecart_account, thrivecart_secret, order_id, invoice_id, order_date, 
        order_timestamp, currency, customer_id, customer: { email, address: { country, state, 
        line1: street, city, zip }, ip_address, first_name, last_name, checkbox_confirmation }, 
        order: { processor, charges }} = req.body;
